...
<head>
	...
	<title>London Cycle Hire Status Map</title>
...
<body onload="init();" style="margin: 0; padding: 0; height: 100%; ">
	...
	<div id='optionwrapper'>
		...
		<div id="optionbox" >
			<table id="keywrapper">
				<tr>
					<td id="themecell">
						Colours: <select id='theme' onchange='updateThemeAndGraphs()'><option></option></select>
					</td>
					<td id="rampcell">
			...
			<div id='title'>London Cycle Hire Dock Status Map</div>		
			<div id='refreshwrapper'>
				<span id='refreshstatus'>&nbsp;</span><span id='timeTillNext'></span>
			</div>		
			<div id='linkswrapper'><span style='font-weight: bold; color: #f00; font-size: 10px;'>NEW</span> <a href="timeline.php">Animation (last 48h)</a> -
	...
	<div id="statsbox">
		<div id='overallgraphs'>
			<div id='balancegraph'></div>
			<div id='overallgraph'></div>
		</div>
		<div id='stats'></div>
		<div class='showhide'>&nbsp; - <a href='javascript:showHideOverallGraphs()'><span class='showhidecap' id='overallgraphsSH'>show</span> graph</a></div>
		<div class='showhide'>&nbsp; - <a href='javascript:showHideStats()'><span class='showhidecap' id='statsSH'>hide</span> stats</a></div>	
		<div class='showhide'>&nbsp;<a href='javascript:showHideTicker()'><span class='showhidecap' id='tickerboxSH'>show</span> ticker</a></div>
	</div>
</body>
</html>
